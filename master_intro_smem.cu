...
/*
gcc -o common.obj -c -fpic common.cpp
nvcc --ptxas-options=-v master_intro_smem.cu
nvcc --resource-usage -link common.obj -o master_intro_smem.out master_intro_smem.cu
